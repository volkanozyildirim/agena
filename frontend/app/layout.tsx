...
export const metadata: Metadata = {
  ...
  description:
    'AGENA is an open-source agentic AI platform that autonomously generates code, creates pull requests, and manages sprints. Multi-agent pipeline, multi-repo orchestration, and ChatOps. Free tier available.',
  keywords: [
    'AI pull request automation',
    'autonomous code generation',
    'AI code review tool',
    'AI sprint refinement',
    'multi-repo AI orchestration',
    'task dependency automation',
    'pixel agent AI workspace',
    'AI developer agent',
